...
class ServerResourcesChart extends React.Component<ServerResourcesChartProps, ServerResourcesChartState> {
	...
	handleActive(interval, caller) {
        let intervals = this.state.intervals.map( (el) => el.caller === caller ? el.interval = interval : el)
        ...
        return (
            <Chart>
                <ChartHeader>
                    ...
                    <UpdateTimer onActive={this.handleActive} caller={this.props.caller}/>
                </ChartHeader>
                {
