...
import { UserText as ProfileText, UserText, CommentText, Title as DashboardTitle } from '../../styles/TextStyles';
...
export const Select = UserPopup.extend`
    ...
    border-bottom-right-radius: ${ (props:any) => props.popup ? '0px' : '0px'};
    border-bottom: ${ (props:any) => props.popup ? '1px solid ghostwhite' : '1px solid'};
